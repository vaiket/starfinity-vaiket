...
Then run one of these SQL files in your Supabase SQL editor:
...
Note: if you only configure URL + anon key, the current app relies on the anon read policy included in these SQL files.
