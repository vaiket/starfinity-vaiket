      ...
      <div className="max-w-4xl mx-auto px-6 py-16 lg:py-24">
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">1. Our Commitment</h2>
            <p className="text-black leading-relaxed mb-4">
              EazyGrow Financial Services Pvt. Ltd. believes in transparent, fair, and honest business practices. We are committed to delivering services as described. If we are unable to deliver a service as committed, we will initiate a refund as per the terms outlined in this policy.
            </p>
            <p className="text-black leading-relaxed">
              Refund requests must be submitted by email to <strong>info@eazygrow.com</strong> with the subject line: "Refund Request – [Your Order/Service Name]". Our team will respond within 2 business days.
            </p>
          </section>

          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">2. Eligibility for Refund</h2>
            <p className="text-black leading-relaxed mb-4">
              A refund may be considered under the following conditions:
            </p>
            <ul className="space-y-2 text-black ml-4">
              <li className="list-disc">EazyGrow is unable to initiate or process the service despite receiving complete documents from the client within the stated timeline.</li>
              ...
              <li className="list-disc">EazyGrow has committed a material error that directly resulted in service failure.</li>
            </ul>
          </section>

          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">3. Non-Refundable Conditions</h2>
            <p className="text-black leading-relaxed mb-4">
              No refund shall be issued in the following circumstances:
            </p>

            <h3 className="text-lg font-semibold text-black mb-3 mt-6">3.1 Government Rejection or Delay</h3>
            <p className="text-black leading-relaxed">
              No refund will be provided if EazyGrow has processed the application as per government guidelines and the registration or certification is rejected, objected to, or delayed by the government department, portal, or authority. Government outcomes are beyond our control.
            </p>

            <h3 className="text-lg font-semibold text-black mb-3 mt-6">3.2 Non-Cooperation by Client</h3>
            <p className="text-black leading-relaxed">
            ...
            <h3 className="text-lg font-semibold text-black mb-3 mt-6">3.3 Government Fees Already Paid</h3>
            <p className="text-black leading-relaxed">
            ...
            <h3 className="text-lg font-semibold text-black mb-3 mt-6">3.4 Partially Delivered Services</h3>
            <ul className="space-y-2 text-black ml-4">
            ...
            <h3 className="text-lg font-semibold text-black mb-3 mt-6">3.5 Complimentary Services or Discounts Availed</h3>
            <p className="text-black leading-relaxed">
            ...
            <h3 className="text-lg font-semibold text-black mb-3 mt-6">3.6 Success Fee Payments</h3>
            <p className="text-black leading-relaxed">
            ...
            <h3 className="text-lg font-semibold text-black mb-3 mt-6">3.7 Change of Mind / Delay from Client Side</h3>
            <p className="text-black leading-relaxed">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">4. Refund Process</h2>
            <ul className="space-y-2 text-black ml-4">
              <li className="list-disc"><strong>Step 1 – Submit Request:</strong> Email info@eazygrow.com with your name, order details, reason for refund, and supporting evidence.</li>
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">5. Deductions & Processing Charges</h2>
            <p className="text-black leading-relaxed mb-4">
              Where a partial refund is approved, EazyGrow will deduct:
            </p>
            <ul className="space-y-2 text-black ml-4">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">6. Cancellation Policy</h2>
            <p className="text-black leading-relaxed mb-4">
              Clients may cancel a service order before commencement of work. 'Commencement' means the stage at which EazyGrow's team has begun documentation review, filing, or any substantive action on behalf of the client.
            </p>
            <ul className="space-y-2 text-black ml-4">
              <li className="list-disc"><strong>Cancellation before commencement:</strong> Full refund minus processing charge (min ₹500).</li>
              <li className="list-disc"><strong>Cancellation after commencement but before filing:</strong> Partial refund based on work completed — at EazyGrow's discretion.</li>
              <li className="list-disc"><strong>Cancellation after filing/submission to government portal:</strong> No refund applicable.</li>
            </ul>
          </section>

          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">7. Funding Plans – Special Refund Terms</h2>
            <p className="text-black leading-relaxed mb-4">
            ...
            <ul className="space-y-2 text-black ml-4">
              ...
              <li className="list-disc">If EazyGrow has not initiated any work within 15 business days of payment and document submission (without valid reason), the client is eligible for a full refund minus ₹500 processing charge.</li>
              <li className="list-disc">In all other scenarios, refunds for funding plans will be considered on a case-by-case basis.</li>
            </ul>
          </section>

          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">8. Dispute Resolution</h2>
            <p className="text-black leading-relaxed mb-4">
              If you are unsatisfied with the refund decision, you may escalate the matter to our Grievance Officer at:
            </p>
            <ul className="space-y-2 text-black ml-4 mb-4">
              <li className="list-disc"><strong>Email:</strong> info@eazygrow.com</li>
          ...
          <section>
            <h2 className="text-xl font-bold text-black mb-4">9. Contact for Refund Queries</h2>
            <p className="text-black leading-relaxed mb-4">
            ...
            <ul className="space-y-2 text-black">
              ...
              <li><strong className="text-black">Phone / WhatsApp:</strong> +91 7041894751</li>
              <li><strong className="text-black">Business Hours:</strong> Monday to Saturday, 10:00 AM to 6:30 PM IST</li>
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 text-center text-sm text-black">
          <p>© 2026 EazyGrow Financial Services Pvt. Ltd. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  );
