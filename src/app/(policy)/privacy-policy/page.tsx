      ...
      <div className="max-w-4xl mx-auto px-6 py-16 lg:py-24">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            ...
            <h3 className="text-lg font-semibold text-black mb-3 mt-6">2.1 Personal Identification Information</h3>
            ...
            <h3 className="text-lg font-semibold text-black mb-3 mt-6">2.2 Usage & Technical Information</h3>
            <ul className="space-y-2 text-black ml-4">
            ...
            <h3 className="text-lg font-semibold text-black mb-3 mt-6">2.3 Communication Data</h3>
            <ul className="space-y-2 text-black ml-4">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">3. Purpose of Data Collection</h2>
            <p className="text-black leading-relaxed mb-4">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">4. Data Sharing & Disclosure</h2>
            <p className="text-black leading-relaxed mb-4">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">5. Data Security</h2>
            <p className="text-black leading-relaxed mb-4">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">7. Cookies Policy</h2>
            <p className="text-black leading-relaxed mb-4">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">8. Your Rights as a Data Subject</h2>
            <p className="text-black leading-relaxed mb-4">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">9. Third-Party Websites</h2>
            <p className="text-black leading-relaxed">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">10. Children's Privacy</h2>
            <p className="text-black leading-relaxed">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-black mb-4">11. Changes to This Policy</h2>
            <p className="text-black leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-black mb-4">12. Grievance Officer</h2>
            <p className="text-black leading-relaxed mb-4">
