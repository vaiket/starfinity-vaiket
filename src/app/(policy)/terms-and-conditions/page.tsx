        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-10 pb-8 border-b border-gray-100">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              These Terms and Conditions ("Terms") govern the use of the website www.essygrow.com and all services provided by Easygrow Financial Services Pvt. Ltd. ("EasyGrow", "Company", "we", "us"). By accessing our website, submitting an inquiry, making a payment, or engaging our services, you ("Client", "User", "you") agree to be legally bound by these Terms.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-4">2. About Our Services</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-4">4. Service Engagement & Scope</h2>
            <p className="text-gray-600 leading-relaxed mb-4"><strong>4.1 Service commencement:</strong> Services commence upon receipt of the service fee and submission of all required documents by the client.</p>
            <p className="text-gray-600 leading-relaxed mb-4"><strong>4.2 Timeline:</strong> Estimated timelines are indicative only. Final outcomes are subject to government portal availability, regulatory processing times, and client cooperation in providing documents.</p>
            <p className="text-gray-600 leading-relaxed mb-4"><strong>4.3 Client responsibilities:</strong> The client is responsible for providing accurate, complete, and timely information. Any delays or rejection caused by incorrect information provided by the client will not be the liability of EasyGrow.</p>
            <p className="text-gray-600 leading-relaxed mb-4"><strong>4.4 Government outcomes:</strong> EasyGrow facilitates applications and filings but does not guarantee approval from any government authority, bank, or funding institution. Approval or rejection decisions rest solely with the respective authority.</p>
            <p className="text-gray-600 leading-relaxed"><strong>4.5 Success Fee:</strong> For funding plans, a success fee of 1.5% of funds actually raised/disbursed is applicable post-disbursement, in addition to the upfront plan fee. This will be clearly communicated before engagement.</p>
          </section>

          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-4">5. Fees & Payments</h2>
            <ul className="space-y-2 text-gray-600 ml-4">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-4">9. Force Majeure</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="mb-10 pb-8 border-b border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-4">10. Governing Law & Jurisdiction</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">13. Disclaimer</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
