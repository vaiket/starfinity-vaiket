...
import { MessageCircle, Phone, ArrowRight, CheckCircle, Send, Clock, Users, Zap, Rocket, Shield, Target } from "lucide-react";
    ...
    <section className="relative py-24 px-4 md:px-10 lg:px-20 overflow-hidden bg-gradient-to-b from-gray-950 to-black">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <h1 className={`text-5xl md:text-6xl lg:text-7xl font-bold mb-8 tracking-tight ${bricolage.className}`}>
          ...
          <div className="lg:col-span-2">
            <div className="bg-gradient-to-br from-gray-900 via-gray-900 to-black border border-gray-800 rounded-3xl p-10 shadow-2xl">
              <div className="flex items-center justify-between mb-10">
                <div>
                  <h2 className={`text-3xl font-bold text-white mb-2 ${bricolage.className}`}>Start Your Funding Journey</h2>
                  <p className="text-gray-400 flex items-center gap-2">
                    <Clock className="w-4 h-4" />
                    <span className={`text-gray-400 ${sourceSerif.className}`}>Get response within 24 hours</span>
                  </p>
                </div>
              ...
              {submitted ? (
                <div className="py-20 text-center">
                  ...
                  <h3 className={`text-2xl font-bold text-white mb-4 ${bricolage.className}`}>Application Submitted Successfully!</h3>
                  <p className={`text-gray-400 max-w-md mx-auto ${sourceSerif.className}`}>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    {[
                      ...
                      <div key={field.name} className="group">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <label className={`text-sm font-semibold text-gray-300 group-hover:text-white transition-colors ${sourceSerif.className}`}>
                            {field.label}
                          </label>
                        </div>
                        <input
                          ...
                          className={`w-full px-6 py-4 bg-gray-900/50 border-2 border-gray-800 rounded-xl
                            ...
                            hover:border-gray-700 ${sourceSerif.className}`}
                  ...
                  <div className="flex flex-col sm:flex-row gap-6 items-center justify-between pt-8 border-t border-gray-800">
                    <div className="flex items-center gap-4">
                      ...
                      <span className={`text-sm text-gray-400 ${sourceSerif.className}`}>
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-8">
                  <div>
                    ...
                    <h3 className={`text-2xl font-bold text-white mb-2 ${bricolage.className}`}>WhatsApp Support</h3>
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-8">
                  <div>
                    ...
                    <h3 className={`text-2xl font-bold text-white mb-2 ${bricolage.className}`}>Direct Call</h3>
                    <div className="flex items-center gap-2">
                      <Clock className="w-4 h-4 text-blue-300" />
                      <span className="text-blue-300 font-medium">Mon-Sat: 10 AM - 7 PM</span>
                    </div>
                  </div>
                ...
                <div className="mb-10">
                  <div className="text-3xl font-bold text-white mb-4 tracking-tight">+91 7041894751</div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            >
              ...
              <h4 className={`text-xl font-bold text-white mb-3 ${bricolage.className}`}>{feature.title}</h4>
